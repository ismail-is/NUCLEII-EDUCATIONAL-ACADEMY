      ...
      <div className="container mx-auto px-5">
        <div className="reveal text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mt-4 font-display text-4xl md:text-7xl font-bold tracking-tight leading-[1]">
            Nucleii <span className="text-gradient-pink italic">Educational</span>
            <br /> Academy
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={c.label}
              className="reveal group relative p-8 rounded-3xl bg-white border border-border shadow-card hover:shadow-soft transition-shadow overflow-hidden"
            >
              <div className="absolute -right-16 -top-16 w-48 h-48 rounded-full bg-magenta-soft group-hover:bg-magenta/15 blur-3xl transition" />
        ...
        <div className="container mx-auto px-5">
          <div className="grid md:grid-cols-3 gap-10 items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-display font-bold text-xl text-navy">NUCLEII</div>
