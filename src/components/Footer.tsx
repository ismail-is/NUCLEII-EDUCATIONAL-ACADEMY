    ...
    <footer className="relative bg-navy text-white pt-20 pb-8 overflow-hidden">
      ...
      <div className="relative container mx-auto px-5">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="text-xs uppercase tracking-[0.3em] text-magenta font-semibold">Find Us</div>
          <h2 className="mt-4 font-display text-4xl md:text-6xl font-bold leading-[1] tracking-tight">
            NUCLEII EDUCATIONAL <span className="text-gradient-pink italic">ACADEMY</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto mb-16">
          {[
            { icon: MapPin, label: "Visit Us", lines: ["No. 1, Deepak Arcade, 2nd Floor", "Horamavu Main Road", "Bangalore 560043"] },
            { icon: Phone, label: "Call Experts", lines: ["+91 95387 24158", "080-66468966"] },
            { icon: Mail, label: "Email Us", lines: ["info@nucleii.in"] },
          ].map((c) => (
            <div key={c.label} className="p-7 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-sm hover:bg-white/[0.07] transition">
        ...
        <div className="border-t border-white/10 pt-8 grid md:grid-cols-3 gap-6 items-center">
          <Link to="/" className="flex items-center gap-3 justify-self-center md:justify-self-start">
            ...
            <div>
              ...
              <div className="text-[10px] text-white/60 uppercase tracking-[0.2em]">Educational Academy</div>
            </div>
          </Link>
