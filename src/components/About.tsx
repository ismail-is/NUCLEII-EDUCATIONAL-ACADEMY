      ...
      <div className="container mx-auto px-5 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="reveal">
          ...
          <h2 className="mt-3 font-display text-4xl md:text-6xl font-bold tracking-tight leading-[1.05]">
            Beyond traditional learning, <span className="text-gradient-pink italic">designed</span> for rank.
          </h2>
          <p className="mt-6 text-lg text-muted-foreground">
            ...
            personalised guidance — we help students achieve academic excellence in NEET, JEE and KCET.
          </p>
