  ...
  head: () => ({
    meta: [
      { title: "Contact Us — Nucleii Educational Academy" },
      {
        name: "description",
        content:
          "Reach out to Nucleii — call +91 95387 24158 or email info@nucleii.in for admissions and enquiries.",
      },
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        title={
          <>
            Let's start your <span className="text-gradient-pink italic">journey</span>.
          </>
        }
            ...
            {[
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="mt-2 font-display text-2xl font-bold text-foreground group-hover:text-magenta transition-colors">
                    {c.value}
                  </div>
                </div>
              </motion.a>
        ...
        <div className="container mx-auto px-5 grid lg:grid-cols-12 gap-8">
          ...
          >
            ...
            <p className="mt-3 text-muted-foreground">
              Fill the form — we'll revert to you with more details on your requirement.
            </p>
          ...
          >
            <div className="p-8 rounded-3xl bg-gradient-brand text-white shadow-glow">
              ...
              <div className="mt-5 text-xs uppercase tracking-[0.3em] opacity-70 font-semibold">
                Visit Us
              </div>
              ...
              <p className="mt-4 text-white/85 leading-relaxed">
                2nd Floor, Deepak Arcade, No. 1, Kalkere Main Rd, opposite Prestige Gulmohar
                Apartments, Dodda Kempaiah Layout, Horamavu, Bengaluru, Karnataka 560043
              </p>
